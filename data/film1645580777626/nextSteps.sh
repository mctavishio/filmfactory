...
rm *.png
cd ..
echo "file './film1645580777626/film.mp4'" >> filmfiles.txt 

cp nextSteps_1645580777626.sh film1645580777626/nextSteps.sh
cp textmill001.js film1645580777626/textmill001.js
