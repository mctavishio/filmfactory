...
module.exports = timestamp => {
	...
	const pigmentsets = {
		...
		bwgxyx_051202000200: [ [pigments.black,5, "black"], [pigments.white,12,"white"], [pigments.gray, 2,"gray"], [pigments.red, 0,"red"], [pigments.yellow, 2,"yellow"], [pigments.blue, 0,"blue"]],
	...
	let films = ["bwgxyx_051202000200", "bwgxxx_051201000000", "bwxxyx_051200000200", "bwgrxx_051201020000"].map( (psetkey,k) => {
		return {
	...
	let score = { 
		...
		istween: (nlayer,nlayers,ntick,nticks) => {
			let bar = tools.randominteger(7,10);
