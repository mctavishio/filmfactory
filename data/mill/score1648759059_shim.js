...
module.exports = timestamp => {
	...
	const scoreid = "score1648759059_shim";
	...
	const pigmentsets = {
		...
		bwgxyx_061203000200: [ [pigments.black,5, "black"], [pigments.white,12,"white"], [pigments.gray, 3,"gray"], [pigments.red, 0,"red"], [pigments.yellow, 2,"yellow"], [pigments.blue, 0,"blue"]],
		...
		bwgxxx_061203000000: [ [pigments.black,6, "black"], [pigments.white,12,"white"], [pigments.gray, 3,"gray"], [pigments.red, 0,"red"], [pigments.yellow, 0,"yellow"], [pigments.blue, 0,"blue"]],
		bwgrxx_061203020000: [ [pigments.black,6, "black"], [pigments.white,12,"white"], [pigments.gray, 3,"gray"], [pigments.red, 2,"red"], [pigments.yellow, 0,"yellow"], [pigments.blue, 0,"blue"]],
	...
	let films = ["bwgxxx_061203000000", "bwgrxx_061203020000", "bwgxyx_061203000200", "bwgxxx_061203000000"].map( (psetkey,k) => {
		return {
	...
	let score = { 
		...
		changelayer: (nlayer,nlayers,ntick,nticks) => {
			let bar = tools.randominteger(6,10);
			return (nlayer>nlayers-2 || ntick<2 || ntick>nticks-2) ? true : tools.randominteger(0,10) < bar;
		}
	}
